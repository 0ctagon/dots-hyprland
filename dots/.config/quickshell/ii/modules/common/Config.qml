    ...
    FileView {
        ...
        JsonAdapter {
            ...
            property JsonObject apps: JsonObject {
                ...
                property string changePassword: "konsole -1 --hold=yes fish -i -c 'passwd'"
                property string network: "konsole -1 fish -c nmtui"
                property string manageUser: "kcmshell6 kcm_users"
                property string networkEthernet: "kcmshell6 kcm_networkmanagement"
                property string taskManager: "plasma-systemmonitor --page-name Processes"
                property string terminal: "konsole -1" // This is only for shell actions
                property string update: "konsole -1 --hold=yes fish -i -c 'pkexec pacman -Syu'"
            ...
            property JsonObject launcher: JsonObject {
                property list<string> pinnedApps: [ "org.kde.dolphin", "konsole", "cmake-gui"]
            }
